...
const clientKey = "test_ck_QbgMGZzorzvEezl5KPEDrl5E1em4";
const customerKey = generateRandomString(); //랜덤 고객키
const tossPayments = TossPayments(clientKey); //토스 객체 초기화
const payment = tossPayments.payment({ customerKey }); // 결제를 위한 변수 초기화 (토스 객체에 고객정보 삽입) (토스의 함수 호출)
